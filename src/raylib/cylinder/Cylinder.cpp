...
indie::raylib::Cylinder::Cylinder(::Vector3 position, float radiusTop, float radiusBottom, float height, int slices, ::Color color) : _position(position), _radiusTop(radiusTop), _radiusBottom(radiusBottom), _height(height), _slices(slices), _color(color) {}
