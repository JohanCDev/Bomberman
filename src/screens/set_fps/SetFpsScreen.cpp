...
int indie::menu::SetFpsScreen::handleEvent(indie::Event &event)
{
    ...
    if ((event.controller[0].code == indie::Event::ControllerCode::X_BUTTON || event.key.enter) && _cursorPosition == FPS_30) {
        indie::raylib::Window::setTargetFPS(30);
    }
    if ((event.controller[0].code == indie::Event::ControllerCode::X_BUTTON || event.key.enter) && _cursorPosition == FPS_60) {
